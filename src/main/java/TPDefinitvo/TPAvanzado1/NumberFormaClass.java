...
public class NumberFormaClass {
	...
	public static void main(String[] args) {
		...
		String decimalito=decFormat.format(decimal);
		System.out.println(decimalito);
		double formatDecimal = Double.parseDouble(decimalito.replace(",", "."));//new Double(decimalito).doubleValue();
